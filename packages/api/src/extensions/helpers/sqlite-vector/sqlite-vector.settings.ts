...
export const SQLITE_VECTOR_RAG_HELPER_NAME = 'sqlite-vector' as const;

export const sqliteVectorSettingsSchema = z
  .strictObject({
...
declare global {
  interface RuntimeSettingRegistry {
    [SQLITE_VECTOR_RAG_HELPER_NAME]: typeof sqliteVectorSettingsSchema;
  }
}

export const SqliteVectorSettingsGroup = createSettingGroup({
  group: SQLITE_VECTOR_RAG_HELPER_NAME,
  schema: sqliteVectorSettingsSchema,
  scope: 'extension',
  extensionType: 'helper',
  extensionName: SQLITE_VECTOR_RAG_HELPER_NAME,
});
